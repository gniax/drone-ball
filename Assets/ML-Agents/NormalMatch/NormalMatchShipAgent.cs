...
public class NormalMatchShipAgent : Agent
{
    ...
    private ShipBoosting _boostControl;
    private ShipGroundControl _groundControl;
    private ShipAirControl _airControl;
    ...
    void Start()
    {
        ...
        _airControl = GetComponentInChildren<ShipAirControl>();
        _controller = GetComponentInChildren<ShipController>();
        _boostControl = GetComponentInChildren<ShipBoosting>();
        _groundControl = GetComponentInChildren<ShipGroundControl>();
